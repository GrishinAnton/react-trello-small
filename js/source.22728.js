...
/******/ 	__webpack_require__.p = "/react-trello-small/";
/******/
/******/
...
class Task_Task extends react["Component"] {
  constructor(...args) {
    super(...args);
    this.state = {
      taskEdit: false,
    ...
    this.textInput = react_default.a.createRef();

    this._getActiveTask = () => {
      const {
        completed
      } = this.props;
      return classnames_default()(Task_styles_m_default.a.task, {
...
Task_Task.propTypes = {
  _completedTask: prop_types["func"].isRequired,
  _favoriteTask: prop_types["func"].isRequired,
  _removeTask: prop_types["func"].isRequired,
...
class Composer_class extends react["Component"] {
  constructor(...args) {
    super(...args);
    this.state = {
      comment: ''
  ...
  render() {
    ...
    }), react_default.a.createElement("button", null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443"));
  }

}
Composer_class.propTypes = {
  _addTask: prop_types["func"].isRequired
};
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._renameTask = async (id, taskName) => {
      this._setTaskFetching(true);
  ...
  async componentDidMount() {
    this._setTaskFetching(true); // await this._fetchTasks();
  ...
  render() {
    ...
    })), react_default.a.createElement("section", null, react_default.a.createElement(Composer_class, {
      _addTask: this._addTask
    }), react_default.a.createElement("ul", null, tasksJSX)), react_default.a.createElement("footer", null, react_default.a.createElement(assets_Checkbox, {
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.22728.js.map